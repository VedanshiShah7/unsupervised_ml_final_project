...
from .preprocessing import get_target_label_idx, global_contrast_normalization,custom_transforms_mnist
...
class MNIST_Dataset(TorchvisionDataset):
    ...
    def __init__(self, root: str, normal_class=0,use_custom_transforms=False):
        super().__init__(root)
        ...
        if use_custom_transforms:
          train_transform = custom_transforms_mnist(min_val=min_max[normal_class][0],
